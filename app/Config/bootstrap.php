 ...
 */
Configure::write('Global.Domain','http://stage.longertermloans.net');
...
Configure::write('Offers.Organic.OfferId', '50');
Configure::write('Offers.Organic.CampaignId', '188');
Configure::write('Offers.Organic.CreativeId', '232');
